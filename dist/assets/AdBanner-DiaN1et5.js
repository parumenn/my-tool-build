import{r as c,A as a,j as i}from"./index-DVzXJJLL.js";const d=()=>{const{showAds:s}=c.useContext(a),t=c.useRef(null);return c.useEffect(()=>{var r;if(t.current&&(t.current.innerHTML="",s)){const e=document.createElement("iframe");e.style.width="100%",e.style.height="300px",e.style.border="none",e.style.overflow="hidden",e.title="Advertisement",t.current.appendChild(e);const n=(r=e.contentWindow)==null?void 0:r.document;n&&(n.open(),n.write(`
                <!DOCTYPE html>
                <html>
