...
// チェックを通過した場合、本物のアプリHTML (index.html) を読み込んで出力
$app_view_path = __DIR__ . '/index.html';
...
if (file_exists($app_view_path)) {
    ...
    echo '<!DOCTYPE html><html><body><h1>System Error</h1><p>Application entry point (index.html) not found.</p></body></html>';
}
?>
