    ...
    <div className="max-w-4xl mx-auto space-y-10 pb-20">
      <div className="bg-white dark:bg-dark-lighter rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <div className="flex gap-2"><input type="text" value={newItem} onChange={e => setNewItem(e.target.value)} onKeyDown={e => e.key === 'Enter' && (setItems([...items, newItem]), setNewItem(''))} className="flex-1 p-3 rounded-xl border dark:bg-gray-800 dark:text-white" placeholder="項目追加..." /><button onClick={() => {setItems([...items, newItem]); setNewItem('');}} className="p-3 bg-gray-100 dark:bg-gray-700 rounded-xl"><Plus/></button></div>
