import{r as s,A as a,j as i}from"./index-BjhcaBXY.js";const l=()=>{const{showAds:n}=s.useContext(a),t=s.useRef(null);return s.useEffect(()=>{var c;if(t.current&&(t.current.innerHTML="",n)){const e=document.createElement("iframe");e.style.width="100%",e.style.height="320px",e.style.border="none",e.style.overflow="hidden",e.title="Advertisement",t.current.appendChild(e);const r=(c=e.contentWindow)==null?void 0:c.document;r&&(r.open(),r.write(`
                <!DOCTYPE html>
                <html>
